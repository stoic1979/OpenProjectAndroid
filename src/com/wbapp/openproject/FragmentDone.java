...
public class FragmentDone extends Fragment implements OnClickListener,OnItemClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		taskDoneModel =   DatabaseOperations.getInstance().getAllTasksDoingByProjectId(Config.PROJECT_ID, STATUS);
		
		Log.d("taskDoneModel", "+++++++++Size of taskDoneModel++++++++++++"
				+ taskDoneModel.size());
		if (taskDoneModel.size() == 0)
	...
	public void setTaskData() {
		...
		taskAdapter = new TaskListAdapter(getActivity(), taskDoneModel);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		Config.OKANE(getActivity(), revmob);
		showOptionDialog(taskDoneModel.get(arg2), arg2);
	...
	// dialog for options
			public void showOptionDialog(final Tasks item, final int index) {
				...
				todo.setText("Set As Doing");
				doing.setText("Set As To-Do");
				...
				delete.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						final long ids = taskDoneModel.get(index).getId();
